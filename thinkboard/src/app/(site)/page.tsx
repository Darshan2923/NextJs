...
const HomePage = () => {
    return (
        <>
            <section>
                <section className="overflow-hidden px-6 sm:px-6 mt-20 sm:flex sm:flex-col gap-6 md:justify-center md:items-center">
                    <TitleSection
                    ...
                    <div className="bg-white p-[2px] mt-6 rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px]">
                        <Button
                            variant={'secondary'}
                            className="w-full  rounded-[10px] p-6 text-xl bg-background"
                        >
                            Get ThinkBoard Free
                        </Button>
                    </div>
                    <div className="md:mt-[-90px] sm:w-full w-[750px] flex justify-center items-center  mt-[-40px] relative sm:ml-0 ml-[-50px]">
                        ...
                        />
                        <div className="bottom-0 top-[80%] bg-gradient-to-t dark:from-background left-0 right-0 absolute z-10"></div>
                    </div>
                </section>
